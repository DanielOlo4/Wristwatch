        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center space-x-10">
              <h1 className="text-3xl font-bold bg-gradient-to-r from-[#3D2B1F] to-[#523522] bg-clip-text text-transparent drop-shadow-sm">
                DanTechy
              </h1>
              <nav className="hidden md:flex space-x-8">
                <a href="#" className="text-gray-700 hover:text-[#3D2B1F] font-semibold transition-all duration-300 relative group py-2">
                  International
                  <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-[#3D2B1F] to-[#523522] transition-all duration-300 group-hover:w-full rounded-full"></span>
                </a>
                <a href="#" className="text-gray-700 hover:text-[#3D2B1F] font-semibold transition-all duration-300 relative group py-2">
                  Our universe
                  <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-[#3D2B1F] to-[#523522] transition-all duration-300 group-hover:w-full rounded-full"></span>
            ...
            <div className="relative group">
              <input
                type="text"
                placeholder="Search"
                className="pl-12 pr-6 py-3.5 border-2 border-gray-200/80 rounded-2xl focus:ring-4 focus:ring-[#3D2B1F] focus:border-[#523522] focus:outline-none transition-all duration-300 w-80 bg-white/90 backdrop-blur-sm shadow-lg group-hover:shadow-xl text-gray-700 placeholder-gray-400 font-medium"
              />
              <div className="absolute left-4 top-1/2 transform -translate-y-1/2">
                <svg className="w-5 h-5 text-gray-400 group-hover:text-[#3D2B1F] transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="lg:w-1/4">
            <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl border border-blue-100/50 p-6 sticky top-8 transition-all duration-300 hover:shadow-3xl">
              <div className="text-center mb-8">
                ...
                <h2 className="text-2xl font-bold bg-gradient-to-r from-[#3D2B1F] to-[#523522] bg-clip-text text-transparent">Customer Service</h2>
              </div>
              ...
              <div className="mb-6">
                <a 
                  href="/admin" 
                  className="w-full bg-gradient-to-r from-[#3D2B1F] to-[#523522] hover:from-[#523522] hover:to-[#3D2B1F] text-white px-5 py-4 rounded-xl text-sm font-semibold transition-all duration-300 transform hover:scale-[1.02] shadow-2xl border-2 border-[#523522] flex items-center justify-center space-x-3"
                >
              ...
              {/* Know-how Section */}
              <div className="mb-8">
                <h3 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-4 bg-gradient-to-r from-[#3D2B1F] to-[#523522] px-4 py-3 rounded-xl border border-gray-200/50">
                  Know-how
                </h3>
                    ...
                    <button
                      ...
                      className={`w-full text-left px-5 py-4 rounded-xl text-sm font-semibold transition-all duration-300 transform hover:scale-[1.02] ${
                        activeSection === item.id
                          ? "bg-gradient-to-r from-[#3D2B1F] to-[#523522] text-white shadow-2xl border-2 border-[#523522]"
                          : "text-gray-700 hover:bg-gradient-to-r hover:from-[#3D2B1F] hover:to-[#523522] hover:text-white border-2 border-transparent hover:border-[#523522]"
                      }`}
                    >
              ...
              <div className="border-t border-blue-200/50 pt-8">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <a href="#" className="text-gray-700 hover:text-white p-4 rounded-xl hover:bg-gradient-to-r hover:from-[#3D2B1F] hover:to-[#523522] transition-all duration-300 text-center font-semibold border-2 border-transparent hover:border-[#523522] hover:shadow-lg">
                    MASTER
                  </a>
                  <a href="#" className="text-gray-700 hover:text-white p-4 rounded-xl hover:bg-gradient-to-r hover:from-[#3D2B1F] hover:to-[#523522] transition-all duration-300 text-center font-semibold border-2 border-transparent hover:border-[#523522] hover:shadow-lg">
                    CONQUEST
                  ...
                  <a href="#" className="text-gray-700 hover:text-white p-4 rounded-xl hover:bg-gradient-to-r hover:from-[#3D2B1F] hover:to-[#523522] transition-all duration-300 text-center font-semibold border-2 border-transparent hover:border-[#523522] hover:shadow-lg col-span-2">
                    CLASSIC
                  </a>
                </div>
              </div>
          ...
          <div className="lg:w-3/4">
            <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl border border-blue-100/50 p-8 transition-all duration-500 hover:shadow-3xl">
              ...
              <div className="text-center mb-12">
                ...
                <h1 className="text-5xl font-bold bg-gradient-to-r from-[#3D2B1F] to-[#523522] bg-clip-text text-transparent mb-4 drop-shadow-sm">
                  {contentSections[activeSection].title}
                </h1>
                <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed font-medium">
                  {contentSections[activeSection].content}
                </p>
                <div className="w-32 h-2 bg-gradient-to-r from-[#3D2B1F] to-[#523522] rounded-full mx-auto mt-8 shadow-lg"></div>
              </div>
                      ...
                      <div className="bg-gradient-to-br from-blue-50 to-blue-100/50 p-8 rounded-2xl shadow-xl border-2 border-blue-200/50 transition-all duration-300 hover:shadow-2xl">
                        ...
                        <ul className="text-gray-700 space-y-4 text-lg">
                          <li className="flex items-center">
                            <div className="w-3 h-3 bg-gradient-to-r from-[#3D2B1F] to-[#523522] rounded-full mr-4 flex-shrink-0"></div>
                  ...
                  <div className="space-y-8">
                    <div className="grid md:grid-cols-3 gap-8">
                      <div className="text-center p-8 border-2 border-blue-200/50 rounded-2xl bg-gradient-to-b from-white to-blue-50/70 transition-all duration-300 hover:shadow-2xl">
                        <div className="w-20 h-20 bg-gradient-to-br from-[#3D2B1F] to-[#523522] rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg">
                  ...
                  <div className="space-y-8">
                      ...
                      <div className="divide-y-2 divide-gray-100/50">
                        <div className="p-8">
                          <div className="flex justify-between items-start mb-4">
                            ...
                            <span className="bg-gradient-to-r from-[#3D2B1F] to-[#523522] text-white text-sm px-4 py-2 rounded-full font-semibold shadow-lg">Completed</span>
                          </div>
                          ...
                          <ul className="text-gray-700 space-y-3 text-lg">
                            <li className="flex items-center">
                              <div className="w-2 h-2 bg-[#3D2B1F] rounded-full mr-3"></div>
                        ...
                        <div className="p-8">
                          <div className="flex justify-between items-start mb-4">
                            ...
                            <span className="bg-gradient-to-r from-[#3D2B1F] to-[#523522] text-white text-sm px-4 py-2 rounded-full font-semibold shadow-lg">Registered</span>
                          </div>
                    ...
                    <div className="bg-gradient-to-br from-yellow-50 to-orange-100/50 p-8 rounded-2xl shadow-xl border-2 border-yellow-200/50">
                      ...
                      <p className="text-gray-700 text-xl">
                        ...
                        by <strong className="text-[#3D2B1F]">March 2026</strong> to maintain optimal performance and preserve your warranty.
                      </p>
                    </div>
                  </div>
                )}
                  ...
                  <div className="space-y-8">
                    <div className="grid md:grid-cols-2 gap-8">
                      <div className="border-2 border-blue-200/50 p-8 rounded-2xl bg-gradient-to-b from-white to-blue-50/70 transition-all duration-300 hover:shadow-2xl">
                        <div className="w-16 h-16 bg-gradient-to-br from-[#3D2B1F] to-[#523522] rounded-2xl flex items-center justify-center mb-6 shadow-lg">
                        ...
                        <ul className="text-gray-700 space-y-4 text-lg">
                          <li className="flex items-center">
                            <div className="w-3 h-3 bg-[#3D2B1F] rounded-full mr-4 flex-shrink-0"></div>
                      ...
                      <div className="border-2 border-green-200/50 p-8 rounded-2xl bg-gradient-to-b from-white to-green-50/70 transition-all duration-300 hover:shadow-2xl">
                        ...
                        <ul className="text-gray-700 space-y-4 text-lg">
                          ...
                          <li className="flex items-center">
                            <div className="w-3 h-3 bg-[#3D2B1F] to-[#523522] rounded-full mr-4 flex-shrink-0"></div>
                    ...
                    <div className="bg-gradient-to-br from-gray-50 to-blue-50/50 p-8 rounded-2xl shadow-xl border-2 border-gray-200/50">
                      ...
                      <div className="grid md:grid-cols-3 gap-6">
                        <div className="text-center p-6 border-2 border-blue-200/50 rounded-2xl bg-white transition-all duration-300 hover:shadow-xl hover:border-[#523522]">
                          <h4 className="font-bold text-gray-800 text-xl mb-4">Essential Care</h4>
                          <p className="text-3xl font-bold text-[#3D2B1F] mb-4">₦25,000</p>
                          <p className="text-gray-600 text-lg">Battery replacement + water resistance test</p>
                        </div>
                        <div className="text-center p-6 border-2 border-green-200/50 rounded-2xl bg-white transition-all duration-300 hover:shadow-xl hover:border-[#523522]">
                          <h4 className="font-bold text-gray-800 text-xl mb-4">Premium Service</h4>
                          <p className="text-3xl font-bold text-[#3D2B1F] mb-4">₦75,000</p>
                          <p className="text-gray-600 text-lg">Complete movement service + refinishing</p>
                        </div>
                        <div className="text-center p-6 border-2 border-purple-200/50 rounded-2xl bg-white transition-all duration-300 hover:shadow-xl hover:border-[#523522]">
                          <h4 className="font-bold text-gray-800 text-xl mb-4">Comprehensive</h4>
                          <p className="text-3xl font-bold text-[#3D2B1F] mb-4">₦120,000</p>
                      ...
                      <div className="border-2 border-green-200/50 p-8 rounded-2xl bg-gradient-to-b from-white to-green-50/70 transition-all duration-300 hover:shadow-xl">
                        ...
                        <ul className="text-gray-700 space-y-6 text-lg">
                          <li className="flex items-start">
                            <svg className="w-7 h-7 text-[#3D2B1F] mr-4 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div className="grid md:grid-cols-2 gap-8">
                        <div>
                          ...
                          <div className="bg-gradient-to-r from-blue-50 to-blue-100/50 p-6 rounded-xl border-2 border-blue-200/50">
                            <p className="text-4xl font-bold text-[#3D2B1F] mb-2">3 Years</p>
                        ...
                        <div>
                          ...
                          <div className="bg-gradient-to-r from-green-50 to-green-100/50 p-6 rounded-xl border-2 border-green-200/50">
                            <p className="text-4xl font-bold text-[#3D2B1F] mb-2">+2 Years</p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div>
              ...
              <p className="w-16 h-16 bg-gradient-to-br from-[#3D2B1F] to-[#523522] rounded-full flex items-center justify-center mb-6 shadow-lg overflow-hidden">
                <img 
                  src={logo} 
                  alt="Logo" 
