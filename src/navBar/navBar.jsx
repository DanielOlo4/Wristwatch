...
function Navbar({ cartCount, onLogout, isLoggedIn }) {
  return (
    <nav className="bg-brand-navy text-white px-6 py-4 sticky top-0 z-50 shadow-2xl bg-gradient-to-r from-[#3D2B1F] to-[#523522] backdrop-blur-lg">
        ...
        <div className="flex gap-6 items-center">
          ...
          {isLoggedIn ? (
            <>
              ...
              >
                <LogOut size={20} className="transform group-hover:scale-110 transition-transform duration-300" />
